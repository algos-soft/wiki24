...
@Tag("enums")
@DisplayName("Enumeration TypePage")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class TypePageTest  extends AlgosTest {


    private TypePage[] matrice;
...
//        super.setUpAll();
//        super.typeZero = TypePage.getAllEnums().get(0);
    }
