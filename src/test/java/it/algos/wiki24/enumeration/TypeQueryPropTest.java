...
@Tag("enums")
@DisplayName("Enumeration TypeQueryProp")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class TypeQueryPropTest extends AlgosTest {


    private TypeQueryProp[] matrice;
...
//        super.setUpAll();
//        super.typeZero = TypeQueryProp.getAllEnums().get(0);
    }
    ...
    void matrice() {
        ...
        System.out.println(VUOTA);
        for (TypeQueryProp valore : matrice) {
