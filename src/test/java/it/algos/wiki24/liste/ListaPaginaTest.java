...
@Tag("liste")
@DisplayName("Liste primo livello")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class ListaPaginaTest extends WikiStreamTest {
    ...
    void listaTestoDidascalia(String nomeLista, TypeLista typeLista) {
        ...
        listaStr = appContext.getBean(ListaPagina.class, nomeLista, typeLista).listaTestoDidascalie();
    ...
    @MethodSource(value = "LISTA_LIVELLO_PAGINA")
    @Order(504)
    @DisplayName("504 - dimensione dei paragrafi")
    void mappaDimensioneParagrafi(String nomeLista, TypeLista typeLista) {
        System.out.println(("504 - dimensione dei paragrafi"));
        System.out.println(VUOTA);
        if (byPassaErrori && !fixListe(nomeLista, typeLista)) {
            return;
        }
    ...
    @MethodSource(value = "LISTA_LIVELLO_PAGINA")
    @Order(505)
    @DisplayName("505 - key della mappa (paragrafi)")
    void keyParagrafi(String nomeLista, TypeLista typeLista) {
        System.out.println(("505 - key della mappa (paragrafi)"));
        System.out.println(VUOTA);
        if (byPassaErrori && !fixListe(nomeLista, typeLista)) {
            return;
        }
        ...
        if (listaStr != null) {
            message = String.format("La mappa della lista di type%s[%s] per %s [%s] ha %d chiavi (paragrafi)", FORWARD, typeLista.name(), typeLista.getGiornoAnno(), nomeLista, listaStr.size());
            System.out.println(message);
            System.out.println(VUOTA);
            print(listaStr);
        }
    ...
    @MethodSource(value = "LISTA_LIVELLO_PAGINA")
    @Order(506)
    @DisplayName("506 - dimensione delle sottoPagine")
    void dimensioneSottoPagine(String nomeLista, TypeLista typeLista) {
        System.out.println(("506 - dimensione delle sottoPagine"));
        System.out.println(VUOTA);
        if (byPassaErrori && !fixListe(nomeLista, typeLista)) {
            return;
        }
        ...
        if (mappaSottoPagine != null) {
            message = String.format("La mappa della lista di type%s[%s] per %s [%s] ha %d chiavi (sottoPagine)", FORWARD, typeLista.name(), typeLista.getGiornoAnno(), nomeLista, mappaSottoPagine.size());
            System.out.println(message);
            System.out.println(VUOTA);
            for (String key : mappaSottoPagine.keySet()) {
                message = String.format("%s%s%s", key, FORWARD, mappaSottoPagine.get(key).size());
                System.out.println(message);
            }
        }
        else {
    ...
    @MethodSource(value = "LISTA_LIVELLO_PAGINA")
    @Order(507)
    @DisplayName("507 - key della mappa (keySottoPagine)")
    void keySottoPagine(String nomeLista, TypeLista typeLista) {
        System.out.println(("507 - key della mappa (keySottoPagine)"));
        System.out.println(VUOTA);
        if (byPassaErrori && !fixListe(nomeLista, typeLista)) {
            return;
        }
        ...
        istanza = appContext.getBean(ListaPagina.class, nomeLista, typeLista);
        assertNotNull(istanza);
        listaStr = istanza.getKeySottoPagine();
    ...
    @MethodSource(value = "LISTA_LIVELLO_PAGINA")
    @Order(508)
    @DisplayName("508 - mappa sottoPagine")
    void mappaSottoPagine(String nomeLista, TypeLista typeLista) {
        System.out.println(("508 - mappa sottoPagine"));
        System.out.println(VUOTA);
        if (byPassaErrori && !fixListe(nomeLista, typeLista)) {
            return;
        }
        ...
        if (mappaSottoPagine != null) {
            ...
            for (String key : mappaSottoPagine.keySet()) {
                ...
                System.out.println(message);
                for (WrapDidascalia wrap : mappaSottoPagine.get(key)) {
    ...
    @MethodSource(value = "LISTA_LIVELLO_PAGINA")
    @Order(701)
    @DisplayName("701 - mappa singola sottopagina")
    void mappaSottoPagina(String nomeLista, TypeLista typeLista) {
        System.out.println(("701 - mappa singola sottopagina"));
        System.out.println(VUOTA);
        if (byPassaErrori && !fixListe(nomeLista, typeLista)) {
            return;
        }
        ...
        if (listaStr.size() > 0) {
            ...
            for (String keySottoPagina : listaStr) {
                Map<String, List<WrapDidascalia>> mappa = istanza.mappaWrapDidascalieSotto(keySottoPagina);
                if (mappa.size()>1) {
                    message = String.format("La sottoPagina [%s/%s] ha %d paragrafi", nomeLista, keySottoPagina, mappa.size());
                    System.out.println(message);
                    System.out.println(mappa.keySet());
                }
                else {
                    message = String.format("La sottoPagina [%s/%s] NON ha paragrafi", nomeLista, keySottoPagina);
                    System.out.println(message);
                }
                System.out.println(VUOTA);
            }
    ...
    @MethodSource(value = "LISTA_LIVELLO_PAGINA")
    @Order(702)
    @DisplayName("702 - body singola sottopagina")
    void bodySottoPagina(String nomeLista, TypeLista typeLista) {
        System.out.println(("702 - body singola sottopagina"));
        System.out.println(VUOTA);
        if (byPassaErrori && !fixListe(nomeLista, typeLista)) {
            return;
        }
    ...
    @MethodSource(value = "LISTA_LIVELLO_PAGINA")
    @Order(901)
    @DisplayName("901 - printBodySottoPagina")
    void printBodySottoPagina(String nomeLista, TypeLista typeLista) {
        System.out.println(("901 - printBodySottoPagina"));
        System.out.println(VUOTA);
        if (byPassaErrori && !fixListe(nomeLista, typeLista)) {
            return;
        }
