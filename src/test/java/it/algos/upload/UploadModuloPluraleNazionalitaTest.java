...
public class UploadModuloPluraleNazionalitaTest extends WikiTest {
    ...
    void getBean() {
        ...
        istanza = appContext.getBean(UploadModuloPluraleNazionalita.class);
        assertNotNull(istanza);
    ...
    void getTextPagina() {
        ...
        ottenuto = appContext.getBean(UploadModuloPluraleNazionalita.class).leggeTestoPagina();
        assertTrue(textService.isValid(ottenuto));
        System.out.println(VUOTA);
    ...
    void leggeTestoModulo() {
        ...
        ottenuto = appContext.getBean(UploadModuloPluraleNazionalita.class).leggeTestoModulo();
        assertTrue(textService.isValid(ottenuto));
        System.out.println(VUOTA);
        System.out.println(ottenuto);
    }
    ...
    void leggeMappa() {
        ...
        mappaOttenuta = appContext.getBean(UploadModuloPluraleNazionalita.class).leggeMappa();
    ...
    void getMappaOrdinata() {
        ...
        mappaOttenuta = appContext.getBean(UploadModuloPluraleNazionalita.class).getMappaOrdinata();
        assertNotNull(mappaOttenuta);
        printMappa(mappaOttenuta);
    }
    ...
    void uploadOrdinatoSenzaModifiche() {
        ...
        ottenutoRisultato = appContext.getBean(UploadModuloPluraleNazionalita.class).uploadOrdinatoSenzaModifiche();
