...
public class UploadModuloPluraleAttivitaTest extends WikiTest {
    ...
    void getBean() {
        ...
        istanza = appContext.getBean(UploadModuloPluraleAttivita.class);
        assertNotNull(istanza);
    ...
    void getTextPagina() {
        ...
        ottenuto = appContext.getBean(UploadModuloPluraleAttivita.class).leggeTestoPagina();
        assertTrue(textService.isValid(ottenuto));
        System.out.println(VUOTA);
    ...
    void leggeTestoModulo() {
        ...
        ottenuto = appContext.getBean(UploadModuloPluraleAttivita.class).leggeTestoModulo();
        assertTrue(textService.isValid(ottenuto));
        System.out.println(VUOTA);
        System.out.println(ottenuto);
    }
    ...
    void leggeMappa() {
        ...
        mappaOttenuta = appContext.getBean(UploadModuloPluraleAttivita.class).leggeMappa();
    ...
    void getMappaOrdinata() {
        ...
        mappaOttenuta = appContext.getBean(UploadModuloPluraleAttivita.class).getMappaOrdinata();
        assertNotNull(mappaOttenuta);
        printMappa(mappaOttenuta);
    }
    ...
    void uploadOrdinatoSenzaModifiche() {
        ...
        ottenutoRisultato = appContext.getBean(UploadModuloPluraleAttivita.class).uploadOrdinatoSenzaModifiche();
