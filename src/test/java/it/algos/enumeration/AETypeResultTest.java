...
public class AETypeResultTest extends AlgosUnitTest {


    private AETypeResult type;

    private AETypeResult[] matrice;

    private List<AETypeResult> listaEnum;
    ...
    void matrice() {
        ...
        System.out.println(VUOTA);
        for (AETypeResult valore : matrice) {
    ...
    void forEach() {
        listaEnum = AETypeResult.getAllEnums();
    ...
    void allTag() {
        listaTag = AETypeResult.getAllTags();
