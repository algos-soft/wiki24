...
@Tag("enums")
@DisplayName("Enumeration ContinenteEnum")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class ContinenteEnumTest extends EnumTest {


    private ContinenteEnum[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = ContinenteEnum.getAllEnums().get(0);
    }
    ...
    void matrice() {
        ...
        System.out.println(VUOTA);
        for (ContinenteEnum valore : matrice) {
