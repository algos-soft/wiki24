...
@Tag("enums")
@DisplayName("Enumeration TypeRegione")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class TypeRegioneTest extends EnumTest {


    private TypeRegione[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = TypeRegione.getAllEnums().get(0);
    }
    ...
    void matrice() {
        ...
        System.out.println(VUOTA);
        for (TypeRegione valore : matrice) {
