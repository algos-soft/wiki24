...
@Tag("enums")
@DisplayName("Enumeration FontWeight")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class FontWeightTest extends EnumTest {


    private FontWeight[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = FontWeight.getAllEnums().get(0);
    }
