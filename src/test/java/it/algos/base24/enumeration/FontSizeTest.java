...
@Tag("enums")
@DisplayName("Enumeration FontSize")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class FontSizeTest extends EnumTest {


    private FontSize[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = FontSize.getAllEnums().get(0);
    }
