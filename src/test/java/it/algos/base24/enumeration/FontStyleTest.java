...
@Tag("enums")
@DisplayName("Enumeration FontStyle")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class FontStyleTest extends EnumTest {


    private FontStyle[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = FontStyle.getAllEnums().get(0);
    }
