...
@Tag("enums")
@DisplayName("Enumeration TypeDate")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class TypeDateTest extends EnumTest {


    private TypeDate[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = TypeDate.getAllEnums().get(0);
    }
