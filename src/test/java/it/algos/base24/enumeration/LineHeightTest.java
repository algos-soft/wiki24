...
@Tag("enums")
@DisplayName("Enumeration LineHeight")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class LineHeightTest extends EnumTest {


    private LineHeight[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = LineHeight.getAllEnums().get(0);
    }
