...
@Tag("enums")
@DisplayName("Enumeration LogLevel")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class LogLevelTest extends EnumTest {


    private LogLevel[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = LogLevel.getAllEnums().get(0);
    }
