...
@Tag("enums")
@DisplayName("Enumeration MenuGroup")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class MenuGroupTest extends EnumTest {


    private MenuGroup[] matrice;
    ...
    protected void setUpAll() {
        super.setUpAll();
        super.typeZero = MenuGroup.getAllEnums().get(0);
    }
