...
import static it.algos.wiki24.wiki.query.QueryLogin.*;
...
public class QueryLoginAssertTest {
    ...
    void secondaryRequestPost() {
        ...
        try {
            ...
            elaboraSecondaryResponse(urlResponse2);
    ...
    @Test
    @Order(42)
    @DisplayName("42 - assertCookiesLogin")
    void assertCookiesLogin() {
        System.out.println("41 - assertCookiesLogin");
        URLConnection urlConn1;
        URLConnection urlConn2;
        URLConnection urlConn3;
        Map<String, String> cookiesPrimary = null;
    ...
    protected void elaboraSecondaryResponse(final String rispostaDellaQuery) {
        ...
        if (jsonLogin != null && jsonLogin.get(RESULT) != null) {
            if (jsonLogin.get(RESULT) != null) {
                risultato = (String) jsonLogin.get(RESULT);
            }
