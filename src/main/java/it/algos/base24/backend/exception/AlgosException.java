package it.algos.base24.backend.exception;
...
public class AlgosException extends Exception {
    ...
    private AbstractEntity entityBean;
    ...
    public AlgosException(final Throwable cause, final AbstractEntity entityBean) {
        this(cause, VUOTA, entityBean);
    }

    public AlgosException(final Throwable cause, final String message, final AbstractEntity entityBean) {
        super(message, cause);
        this.message = message;
    ...
    public AbstractEntity getEntityBean() {
        return entityBean;
    }
