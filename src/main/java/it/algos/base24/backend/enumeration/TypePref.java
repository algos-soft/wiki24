 ...
 */
public enum TypePref implements Type {
    string("string", "Blue") {
        @Override
    ...
    bool("bool", "black") {
        ...
        public Boolean bytesToObject(byte[] bytes) {
            ...
            if (bytes != null && bytes.length > 0) {
                byte b = bytes[0];
                //                obj = new Boolean(b == (byte) 0b00000001);//#todo deprecated
                obj = Boolean.valueOf(b == (byte) 0b00000001);
            }
            else {
            //    obj = new Boolean(false);//#todo deprecated
    ...
    localdatetime("datatime", "Fuchsia") {
        ...
        @Override
        public String bytesToString(byte[] bytes) {
            return bytesToObject(bytes).format(DateTimeFormatter.ofPattern("d-MMM-yy H:mm"));
        }
    },// end of single enumeration
    ...
    enumerationType("enumType", "fuchsia") {
        ...
        public byte[] objectToBytes(Object obj) {
            ...
            if (obj instanceof TypePref enumeration) {
    ...
    TypePref(final String tag, final String color) {
        this.setTag(tag);
        this.color = color;
    }// fine del costruttore

    public static List<TypePref> getAllEnums() {
    ...
    public TypePref get(String nome) {
        return getAllEnums()
                .stream()
