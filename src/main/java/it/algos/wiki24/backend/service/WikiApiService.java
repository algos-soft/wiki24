...
public class WikiApiService {
    ...
    public String leggeJSONParse(final String wikiTitleGrezzo) {
        ...
        String rispostaAPI = webService.legge(webUrl);
    ...
    public String leggeHtml(final String wikiTitle) {
        return webService.legge(wikiTitle);
    }
    ...
    public String leggeColonne(String wikiTitle) {
        ...
        int posIni = 0;
        int posEnd = 0;
        String testoPagina = webService.legge(wikiTitle);
    ...
    public String fixCode(String testoGrezzo) {
        ...
        if (testoValido.startsWith(tagIni)) {
            ...
            testoValido = textService.estraeSenza(testoValido, tagIni, tagEnd);
        }
