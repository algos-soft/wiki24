...
public enum WPref implements AIGenPref {
    ...
    downloadNomiIncipit("downloadNomiIncipit", AETypePref.localdatetime, ROOT_DATA_TIME, "Download di Modulo:Incipit nomi."),
    elaboraNomiIncipit("elaboraNomiIncipit", AETypePref.localdatetime, ROOT_DATA_TIME, "Elaborazione dei nomi incipit."),
    elaboraNomiIncipitTime("elaboraNomiIncipitTime", AETypePref.integer, 0, "Durata elaborazione dei nomi incipit."),
    uploadNomiIncipit("uploadNomiIncipit", AETypePref.localdatetime, ROOT_DATA_TIME, "Upload del Modulo:Incipit nomi."),
