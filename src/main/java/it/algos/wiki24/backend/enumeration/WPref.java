...
public enum WPref implements AIGenPref {
    ...
    usaTaskResetBio("usaTaskResetBio", AETypePref.bool, false, "Reset calendarizzato di tutte le biografie con cancellazione completa", null, false),
    ...
    usaSottoGiorniAnni("usaSottoGiorniAnni", AETypePref.bool, true, "Usa le sotto-sottopagine (secoli/mesi) per giorni/anni", null, false),
    sogliaSottoPaginaGiorniAnni("sogliaSottoPaginaGiorniAnni", AETypePref.integer, 50, "Soglia minima per creare una sottopagina di un giorno o anno sul server wiki", null, false),

    categoriaBio("categoriaBio", AETypePref.string, "BioBot", "Categoria di riferimento per le Biografie", null, false),
    sogliaAttNazWiki("sogliaAttNazWiki", AETypePref.integer, 50, "Soglia minima per creare la pagina di una attività o nazionalità sul server wiki", null, false),
    sogliaSottoPagina("sogliaSottoPagina", AETypePref.integer, 50, "Soglia minima per creare una sottopagina di una attività o nazionalità sul server wiki", null, false),
    sogliaDiv("sogliaDiv", AETypePref.integer, 5, "Soglia minima per usare {{Div col}}", null, false),
    sogliaIncludeAll("sogliaIncludeAll", AETypePref.integer, 200, "Soglia minima per 'includere' la voce in giorni/anni", null, false),
    sogliaIncludeParagrafo("sogliaIncludeParagrafo", AETypePref.integer, 50, "Soglia minima per usare i paragrafi 'inclusi' di secondo livello", null, false),

    usaTreAttivita("usaTreAttivita", AETypePref.bool, false, "Considera tutte le attività (tre) nelle liste di attività", null, false),
    usaTreAttivitaStatistiche("usaTreAttivitaStatistiche", AETypePref.bool, true, "Considera tutte le attività (tre) nelle statistiche di attività", null, false),
    usaParagrafiDimensionati("usaParagrafiDimensionati", AETypePref.bool, true, "Nel titolo del paragrafo aggiunge la dimensione delle " + "voci elencate", null, false),
    usaLinkStatistiche("usaLinkStatistiche", AETypePref.bool, true, "Link alle liste di attività nel template statistiche, anche se " + "rossi", null, false),
    typeTocAttNaz("typeTocAttNaz", AETypePref.enumerationType, AETypeToc.forceToc, "Type di TOC in attività e nazionalità", AETypeToc.noToc, false),
    typeTocGiorni("typeTocGiorni", AETypePref.enumerationType, AETypeToc.forceToc, "Type di TOC nelle liste di giorni", AETypeToc.noToc, false),
    typeTocAnni("typeTocAnni", AETypePref.enumerationType, AETypeToc.forceToc, "Type di TOC nelle liste di anni", AETypeToc.noToc, false),
    typeChiaveNulla("typeChiaveNulla", AETypePref.enumerationType, AETypeChiaveNulla.inCoda, "Posizione del paragrafo 'nullo'", AETypeChiaveNulla.inCoda, false),

    usaSottoCognomi("usaSottoCognomi", AETypePref.bool, false, "Usa le sotto-sottopagine per i cognomi", null, false),

    usaParagrafiGiorni("usaParagrafiGiorni", AETypePref.bool, true, "Usa i paragrafi (secoli) nelle pagine dei giorni", null, false),
    usaParagrafiAnni("usaParagrafiAnni", AETypePref.bool, true, "Usa i paragrafi (mesi) nelle pagine degli anni", null, false),
    usaParagrafiAttNaz("usaParagrafiAttNaz", AETypePref.bool, true, "Usa i paragrafi (nazionalità/attività) nelle pagine attività/nazionalità", null, false),
    usaSottoSottoAttNaz("usaSottoSottoAttNaz", AETypePref.bool, false, "Usa le sotto-sottopagine (nazionalità/attività) di lettere alfabetiche", null, false),
    usaDivAttNaz("usaDivAttNaz", AETypePref.bool, false, "Usa i {{Div col}} nelle pagine attività e nazionalità", null, false),

    simboloNato("simboloNato", AETypePref.string, "n.", "Simbolo della nascita nelle didascalie", null, false),
    simboloMorto("simboloMorto", AETypePref.string, "†", "Simbolo della morte nelle didascalie", null, false),
    usaSimboliCrono("usaSimboliCrono", AETypePref.bool, true, "Uso dei simboli crono per nati e morti", null, false),

    linkCrono("linkCrono", AETypePref.enumerationType, AETypeLink.lista, "Type di link a giorni/anni nelle didascalie", AETypeLink.nessuno, false),
    linkAttNaz("linkAttNaz", AETypePref.enumerationType, AETypeLink.lista, "Type di link nei titoli dei paragrafi in attività/nazionalità", AETypeLink.nessuno, false),
    linkGiorniAnni("linkGiorniAnni", AETypePref.enumerationType, AETypeLink.nessuno, "Type di link nei titoli dei paragrafi in giorni/anni", AETypeLink.nessuno, false),
    linkCognomi("linkCognomi", AETypePref.enumerationType, AETypeLink.pagina, "Type di link nei titoli dei paragrafi in persone di cognome", AETypeLink.nessuno, false),

    usaTaskBio("usaTaskBio", AETypePref.bool, true, "Download calendarizzato di tutte le biografie", null, false),
    usaTaskGiorni("usaTaskGiorni", AETypePref.bool, true, "Upload calendarizzato di tutte le pagine dei giorni nato/morto", null, false),
    usaTaskAnni("usaTaskAnni", AETypePref.bool, true, "Upload calendarizzato di tutte le pagine degli anni nato/morto", null, false),
    usaTaskAttivita("usaTaskAttivita", AETypePref.bool, true, "Upload calendarizzato di tutte le attività", null, false),
    usaTaskNazionalita("usaTaskNazionalita", AETypePref.bool, true, "Upload calendarizzato di tutte le nazionalità", null, false),
    usaTaskCognomi("usaTaskCognomi", AETypePref.bool, false, "Upload calendarizzato di tutte le pagine dei cognomi", null, false),
    usaTaskNomi("usaTaskNomi", AETypePref.bool, false, "Upload calendarizzato di tutte le pagine dei nomi", null, false),
    usaTaskElabora("usaTaskElabora", AETypePref.bool, false, "Lista pagine da cancellare e lista errori", null, false),
    usaTaskStatistiche("usaTaskStatistiche", AETypePref.bool, true, "Elaborazione delle statistiche", null, false),


    usaRigheGiorni("usaRigheGiorni", AETypePref.bool, false, "Usa righe raggruppate per anno nelle liste dei giorni", null, false),
    usaRigheAnni("usaRigheAnni", AETypePref.bool, false, "Usa righe raggruppate per giorno nelle liste degli anni", null, false),
    sogliaCognomiMongo("sogliaCognomiMongo", AETypePref.integer, 30, "Soglia minima per creare una entity nella collezione Cognomi sul mongoDB", null, false),
    sogliaCognomiWiki("sogliaCognomiWiki", AETypePref.integer, 50, "Soglia minima per creare una pagina Cognomi sul server wiki", null, false),
    usaLoggerTask("usaLoggerTask", AETypePref.bool, true, "Registra sul log interno l'esecuzione delle task programmate", null, false),
    ...
    maxPageLength("maxPageLength", AETypePref.integer, 200000, "Soglia massima di una pagina in byte", null, false),
    maxBioPageAnniGiorni("maxBioPageAnniGiorni", AETypePref.integer, 1700, "Soglia massima di bio per usare le sottopagine  giorni/anni", null, false),
    scriveComunque("scriveComunque", AETypePref.bool, false, "Forza comunque la registrazione della pagina anche se le modifiche sono sulla data", null, false),
    sottoCategorieNatiPerAnno("sottoCategorieNatiPerAnno", AETypePref.bool, true, "Categorizzazione per secoli delle liste di 'Nati per anno'", null, false),
    ;
    ...
    WPref(final String keyCode, final AETypePref type, final Object defaultValue, final String descrizione) {
        this(keyCode, type, defaultValue, descrizione, null, true);
    ...
    WPref(final String keyCode, final AETypePref type, final Object defaultValue, final String descrizione, AITypePref typeEnum) {
        this(keyCode, type, defaultValue, descrizione, typeEnum, true);
    }// fine del costruttore

    WPref(final String keyCode, final AETypePref type, final Object defaultValue, final String descrizione, AITypePref typeEnum, boolean dinamica) {
