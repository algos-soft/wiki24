...
public class ParGiornoNatoForm extends CrudForm {


    public ParGiornoNatoForm(ParGiornoNatoModulo crudModulo, ParGiornoNatoEntity entityBean, CrudOperation operation) {
