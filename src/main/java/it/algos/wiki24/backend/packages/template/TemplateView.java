...
public class TemplateView extends CrudView {


    //--per eventuali metodi specifici
    private TemplateBackend backend;
     ...
     */
    public TemplateView(@Autowired final TemplateBackend crudBackend) {
        super(crudBackend, Template.class);
