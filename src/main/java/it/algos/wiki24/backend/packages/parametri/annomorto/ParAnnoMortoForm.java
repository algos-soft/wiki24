...
public class ParAnnoMortoForm extends CrudForm {


    public ParAnnoMortoForm(ParAnnoMortoModulo crudModulo, ParAnnoMortoEntity entityBean, CrudOperation operation) {
