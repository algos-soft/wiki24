...
public class ParGiornoMortoForm extends CrudForm {


    public ParGiornoMortoForm(ParGiornoMortoModulo crudModulo, ParGiornoMortoEntity entityBean, CrudOperation operation) {
