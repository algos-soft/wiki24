...
public class ParLuogoMortoForm extends CrudForm {


    public ParLuogoMortoForm(ParLuogoMortoModulo crudModulo, ParLuogoMortoEntity entityBean, CrudOperation operation) {
