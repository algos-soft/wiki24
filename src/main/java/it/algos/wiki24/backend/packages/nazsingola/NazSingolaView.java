 ...
 */
@PageTitle("nazsingola")
@Route(value = "nazsingola", layout = MainLayout.class)
public class NazSingolaView extends CrudView {


    //--per eventuali metodi specifici
    private NazSingolaBackend backend;
     ...
     */
    public NazSingolaView(@Autowired final NazSingolaBackend crudBackend) {
        super(crudBackend, NazSingola.class);
