 ...
 * Time: 06:31
 */
public abstract class ListaAstratta {
    ...
    protected Map<String, List<WrapDidascalia>> mappaSottoPagine = new LinkedHashMap<>();
     ...
     */
    public ListaAstratta(final String nomeLista, TypeLista typeLista) {
    ...
    public void fixRegolazioni() {
        ...
        this.typeWrap = switch (typeLista) {
    ...
    public Map<String, List<WrapDidascalia>> mappaWrapDidascalieSotto(String keySottoPagina) {
        List<WrapDidascalia> listaSottoPagina = mappaSottoPagine.get(keySottoPagina);
        return mappaWrapDidascalieSotto(listaSottoPagina);
    }
    ...
    public String singoloParagrafo(String keyParagrafo) {
        ...
        if (usaSottoPagineLista && numBio > sogliaVociTotaliPaginaPerSottopagine && numVociParagrafo > sogliaSottoPagina) {
            ...
            mappaSottoPagine.put(keyParagrafo, mappaWrapDidascalie.get(keyParagrafo));
        }
        else {
            if (usaDiv) {
    ...
    public Map<String, List<WrapDidascalia>> getMappaSottoPagine() {
        return mappaSottoPagine;
    }

    public List<String> getKeySottoPagine() {
        return mappaSottoPagine != null && mappaSottoPagine.size() > 0 ? mappaSottoPagine.keySet().stream().toList() : new ArrayList<>();
    }
    ...
    public String getBodySottoPagina(String keySottoPagina) {
        ...
        if (!getKeySottoPagine().contains(keySottoPagina)) {
            return VUOTA;
        }
    ...
    public int getNumBioSottoPagina(String keySottoPagina) {
        return mappaSottoPagine != null ? mappaSottoPagine.get(keySottoPagina).size() : 0;
    }
